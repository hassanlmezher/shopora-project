...
function StoreCard({image, name} : StoreItem) {
  return (
    <div className="flex w-full flex-col items-center justify-center rounded-3xl border border-gray-200 bg-white px-6 py-8 text-center shadow-sm">
        ...
        <button className="mt-8 w-full max-w-[140px] rounded-2xl bg-[#EAEAEA] py-2 font-bold transition duration-300 ease-in-out hover:bg-black hover:text-[#F7F0E0]">Explore</button>
    </div>
  )
}
