    ...
    <>
      <article className="relative flex h-full w-full max-w-[320px] flex-col gap-5 rounded-[28px] border border-blue-100 bg-linear-to-b from-blue-50 via-white to-white shadow-[0_25px_45px_rgba(59,124,255,0.18)]">
        ...
        <div className="flex gap-3 rounded-b-[28px] border-t border-blue-100 bg-white px-6 py-3">
          <button
            className="flex-1 min-h-[42px] rounded-[20px] border border-transparent bg-linear-to-r from-[#5F9EFF] to-[#7CA6FF] px-3 py-2 text-[11px] font-bold uppercase tracking-widest text-white shadow-md transition hover:opacity-90 hover:scale-[1.01]"
            onClick={handleAddToCart}
          >
            Add to cart
          </button>
          <button
            className="flex-1 min-h-[42px] rounded-[20px] border-2 border-[#7CA6FF] bg-white px-3 py-2 text-[11px] font-bold uppercase tracking-widest text-[#7CA6FF] transition hover:bg-[#7CA6FF] hover:text-white hover:scale-[1.01]"
