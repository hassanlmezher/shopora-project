  ...
  return (
    <div className="flex justify-center items-center bg-linear-to-b from-[#66CE9A] to-[#388063] h-screen">
      <div className="bg-[#D9D9D9] flex flex-col justify-center items-center h-120 w-100 rounded-l-4xl">
        ...
        <button className="text-white font-bold bg-[#65CD99] border-none rounded-2xl text-[19px] w-40 h-12 mt-10 transition duration-300 ease-in-out hover:bg-white hover:text-[#65CD99]">Log In</button>
      </div>
